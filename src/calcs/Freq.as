package calcs
{
	public class Freq
	{
		...
		//returns 12 months for the changed year
		public function year_2_months(baseData:Array, newData:Array, yrInd:uint, indicator:String):Array {
			var rez:Array = new Array();
			var baseYear:Number = baseData[yrInd][indicator];
			var newYear :Number = newData[yrInd][indicator];
			var ratio  :Number = newYear/baseYear;  
			
			
			for (var i:uint = (yrInd - 11); i < 12; i++) {
				rez
			};			
			return rez;
		}
